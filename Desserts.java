...
public class Desserts extends JFrame implements ActionListener
{
    JLabel label1;
    JLabel label2;
    JLabel label3;
    ...
    Desserts()
    {
        ...
        setTitle("Select Desserts");
        setLocationRelativeTo(null);
        setLayout(null);
        getContentPane().setBackground(Color.BLACK);
        
        Color color=new Color(0,60,250);
        label1=new JLabel("Desserts",JLabel.CENTER);
        label1.setOpaque(true);
        label1.setBackground(color);
        label2=new JLabel("Cheese Cake");
        label2.setToolTipText("Cheese Cake");
        label3=new JLabel("Chocolate Pie");
        label3.setToolTipText("Chocolate Pie");
        label4=new JLabel("English Trifle");
        label4.setToolTipText("English Trifle");
        label7=new JLabel("Rs 400");
        label8=new JLabel("Rs 180");
        label9=new JLabel("Rs 200");
        color1=new JLabel();
        color2=new JLabel();
        color3=new JLabel();
        ...
        img1=new ImageIcon(getClass().getResource("Food Items\\Cheesecake.jpg"));
        img1=new ImageIcon(img1.getImage().getScaledInstance(80,80, Image.SCALE_DEFAULT));
        imgl1=new JLabel(img1);
        img2=new ImageIcon(getClass().getResource("Food Items\\Chocolate Pie.jpg"));
        img2=new ImageIcon(img2.getImage().getScaledInstance(80,80, Image.SCALE_DEFAULT));
        imgl2=new JLabel(img2);
        img3=new ImageIcon(getClass().getResource("Food Items\\English Trifle.jpg"));
        ...
        //label5.setBounds(90,370,100,25);
        //label6.setBounds(90,460,100,25);
        ...
        //t4.setBounds(230,380,30,30);
        //t5.setBounds(230,470,30,30);
        ...
        //d4.setBounds(200,380,30,30);
        //i4.setBounds(260,380,30,30);
       // d5.setBounds(200,470,30,30);
        //i5.setBounds(260,470,30,30);
        ...
        //i5.addActionListener(this);
            ...
            hm.put("Cheese Cake",a1);
            hm.put("Chocolate Pie", a2);
            hm.put("English Trifle", a3);
