...
public class Beverages extends JFrame implements ActionListener
{
    ...
    Beverages()
    {
       ...
       // setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setTitle("Select Beverages");
        setLocationRelativeTo(null);
        setLayout(null);
        getContentPane().setBackground(Color.BLACK);
        
        Color color=new Color(0,60,250);
        label1=new JLabel("Beverages",JLabel.CENTER);
        label1.setOpaque(true);
        label1.setBackground(color);
        label2=new JLabel("Cappucino");
        label2.setToolTipText("Cappucino");
        label3=new JLabel("Espresso");
        label3.setToolTipText("Espresso");
        label4=new JLabel("Mocha");
        label4.setToolTipText("Mocha");
        label5=new JLabel("Latte");
        label5.setToolTipText("Latte");
        label6=new JLabel("Cold Coffee");
        label6.setToolTipText("Cold Coffee");
        label7=new JLabel("Rs 70");
        label8=new JLabel("Rs 50");
        label9=new JLabel("Rs 80");
        label10=new JLabel("Rs 80");
        label11=new JLabel("Rs 100");
        color1=new JLabel();
        color2=new JLabel();
        color3=new JLabel();
        color4=new JLabel();
        ...
        img1=new ImageIcon(getClass().getResource("Food Items\\Cappucino.jpg"));
        img1=new ImageIcon(img1.getImage().getScaledInstance(80,80, Image.SCALE_DEFAULT));
        imgl1=new JLabel(img1);
        img2=new ImageIcon(getClass().getResource("Food Items\\\\Espresso.jpg"));
        img2=new ImageIcon(img2.getImage().getScaledInstance(80,80, Image.SCALE_DEFAULT));
        imgl2=new JLabel(img2);
        img3=new ImageIcon(getClass().getResource("Food Items\\\\Mocha.jpg"));
        img3=new ImageIcon(img3.getImage().getScaledInstance(80,80, Image.SCALE_DEFAULT));
        imgl3=new JLabel(img3);
        img4=new ImageIcon(getClass().getResource("Food Items\\\\Latte.jpg"));
        img4=new ImageIcon(img4.getImage().getScaledInstance(80,80, Image.SCALE_DEFAULT));
        imgl4=new JLabel(img4);
        img5=new ImageIcon(getClass().getResource("Food Items\\Cold Coffee.jpg"));
        ...
        label2.setBounds(90,100,150,25);
        label3.setBounds(90,190,150,25);
        label4.setBounds(90,280,150,25);
        label5.setBounds(90,370,150,25);
        label6.setBounds(90,460,150,25);
        ...
        t1.setBounds(280,110,30,30);
        t2.setBounds(280,200,30,30);
        t3.setBounds(280,280,30,30);
        t4.setBounds(280,380,30,30);
        t5.setBounds(280,470,30,30);
        d1.setBounds(250,110,30,30);
        i1.setBounds(310,110,30,30);
        d2.setBounds(250,200,30,30);
        i2.setBounds(310,200,30,30);
        d3.setBounds(250,280,30,30);
        i3.setBounds(310,280,30,30);
        d4.setBounds(250,380,30,30);
        i4.setBounds(310,380,30,30);
        d5.setBounds(250,470,30,30);
        i5.setBounds(310,470,30,30);
